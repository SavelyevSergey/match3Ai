...
### 8.4. Без сторонних плагинов
Все системы реализуются на чистом C# и Unity API:
- DOTween → собственная система анимации через Coroutines
- PlayFab → собственная система сохранений через PlayerPrefs/JSON
- Firebase → Unity Analytics (встроенная аналитика)
...
### D. Примеры конфигураций уровней
```json
{
  "levelNumber": 1,
  "gridConfig": {
  ...
  "elementTypes": ["Red", "Blue", "Green", "Yellow", "Purple"],
  "obstacles": []
}
```
