...
> **Примечание:** Детальные оптимизации см. в [10_Технические_требования.md:73-83](Docs/Plan/10_Технические_требования.md:73)

- **Object Pooling (ОБЯЗАТЕЛЬНО):** Пул объектов для списков и очередей BFS
